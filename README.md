...
| 種類 | 内容 |
|---|---|
| コマンド 13 | delve-start / status / style / audit / report / improve / demo / watch / adlp / adscript / sns / feedback（自然文から自動発火） |
| 日本語コマンド 11 | /サイト診断 /スタイル調査 /ページ改善 /タスク開始 /状態確認 /作業レポート /デモ /競合ウォッチ /広告からLP /動画広告 /SNS運用 |
